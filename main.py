...
def main(resolucao=None, lotes=None, dt_cookie=None, jsession_id=None):
    ...
    for _ in range(2):
        baixar_comprovantes(lotes, cookies, URL_GCPJ, CAMINHO_PASTA_LOTES_MULTIPAG, CAMINHO_CONCLUIDOS, r'.\COMPROVANTES')
if __name__ == '__main__':
    main(resolucao='1920X1080', lotes=[13736, 13737, 13738, 13739])
